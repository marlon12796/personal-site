		...
		<main className="w-full [padding-inline:2rem] mb-16">
			<section>
				<div className="text-slate-500 gap-x-4 items-center justify-between  md:flex md:gap-x-10">
					<div className="space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
						<h2 className="text-4xl text-slate-300 font-extrabold md:text-5xl">
							Simplifying digital experiences for everyone.
						</h2>
						<p>
							Crafting accessible, intuitive solutions alongside Programmer
							Marlon to enhance user interactions.
						</p>
						<Link
							href="/static/cv.pdf"
							target="_blank"
						...
						>
							<span className="[padding-inline-start:1em] font-semibold text-slate-300 ">
								Download CV
							</span>
			...
			<section className="text-slate-500 [padding-block-start:2em]">
				<h2 className="text-2xl font-bold tracking-tight  text-slate-300 dark:text-zinc-100 sm:text-4xl">
					I&apos;m Marlon, dedicated to making digital experiences simpler and
					more user-friendly for everyone.
				</h2>
				<p className="[padding-block-start:1.5em]">
					Hey there! My name is Marlon. I&apos;m passionate about demystifying
					technology and crafting interfaces that speak to everyone. With a keen
					eye for design and a heart for code, I bridge the gap between the
					complex and the accessible. I started my career as a web developer
					about 8 years ago.
				</p>
				...
				<p className="[padding-block-start:0.5em]">
					...
					interested and focused on Front-End Development and Sql.
				</p>
			</section>
			<section>
