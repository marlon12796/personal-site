		...
		<main className='w-full [padding-inline:2rem] mb-16'>
			...
			<section className='text-slate-500 [padding-block-start:2em]'>
				...
				<p className='[padding-block-start:1.5em]'>
					Hey there! My name is Marlon. I&apos;m passionate about demystifying technology and crafting interfaces that
					speak to everyone. With a keen eye for design and a heart for code, I bridge the gap between the complex and
					the accessible. I started my career as a web developer about 8 years ago.
				</p>
				<p className='[padding-block-start:0.5em]'>
					I&apos;ve tried some programming languages and tech stack, both Back-End, and Front-End.
				</p>
				<p className='[padding-block-start:0.5em]'>
					Even though the scope of web development is broad, I was very interested and focused on Front-End Development
					and Sql.
				</p>
			</section>
			<section>
